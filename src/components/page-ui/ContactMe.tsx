...
export function ContactMeForm() {
  ...
  Designed in <a href="https://www.figma.com/" className="text-blue-500 hover:underline">Figma</a>, built in <a href="https://zed.dev/" className="text-blue-500 hover:underline">Zed</a>, using <a href="https://nextjs.org/" className="text-blue-500 hover:underline">Next.js,</a> deployed with <a href="https://vercel.com/" className="text-blue-500 hover:underline">Vercel</a> by  <a href="https://github.com/ryouol/RoyPortfolio" className="text-blue-500 hover:underline">Roy Luo</a> 
</footer>
            <footer className="mt-10 text-center text-sm text-gray-500">
    © {new Date().getFullYear()} Roy Luo. Code licensed under the <a href="https://opensource.org/licenses/MIT" className="text-blue-500 hover:underline">MIT License</a>. All rights reserved.
</footer>
        </div>
    );
}
