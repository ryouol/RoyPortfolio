    ...
    >
      ...
      <div className="max-w-xl space-y-8">
        <div className="text-lg">
          <p>
            Open to building new connections, collaborating on
            projects-hackathons-competitions, and future opportunites!
          </p>
          <ul className="mt-4 list-disc pl-10">
            <li>
              Email:{" "}
              <a
                href="mailto:royluo05@gmail.com"
            ...
            <li>
              School Email:{" "}
              <a
                href="mailto:r55luo@uwaterloo.ca"
                className="text-blue-500 hover:underline"
              >
                r55luo@uwaterloo.ca
              </a>
      ...
      <footer className="mt-10 text-center text-sm text-gray-500">
        ...
        by{" "}
        <a
          href="https://github.com/ryouol/RoyPortfolio"
          className="text-blue-500 hover:underline"
        >
          Roy Luo
        </a>
